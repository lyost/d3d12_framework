#ifndef TEST_GRAPHICS_PIPELINE_POS_TEX_U_H
#define TEST_GRAPHICS_PIPELINE_POS_TEX_U_H
...
class TestGraphicsPipelinePosTexU
{
  public:
    TestGraphicsPipelinePosTexU(GraphicsCore& graphics);
    ~TestGraphicsPipelinePosTexU();
    ...
    /// model to render
    /// </param>
    void SetModel(const TestModelPosTexU* model);
  ...
  private:
    // disabled
    TestGraphicsPipelinePosTexU();
    TestGraphicsPipelinePosTexU(const TestGraphicsPipelinePosTexU& cpy);
    TestGraphicsPipelinePosTexU& operator=(const TestGraphicsPipelinePosTexU& cpy);

    /// <summary>
    /// test model
    /// </summary>
    const TestModelPosTexU* m_model;
...
#endif /* TEST_GRAPHICS_PIPELINE_POS_TEX_U_H */
