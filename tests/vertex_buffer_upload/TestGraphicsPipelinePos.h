#ifndef TEST_GRAPHICS_PIPELINE_POS_H
#define TEST_GRAPHICS_PIPELINE_POS_H
...
class TestGraphicsPipelinePos
{
  public:
    TestGraphicsPipelinePos(GraphicsCore& graphics);
    ~TestGraphicsPipelinePos();
    ...
    /// model to render
    /// </param>
    void SetModel(const TestModelPos* model);
  ...
  private:
    // disabled
    TestGraphicsPipelinePos();
    TestGraphicsPipelinePos(const TestGraphicsPipelinePos& cpy);
    TestGraphicsPipelinePos& operator=(const TestGraphicsPipelinePos& cpy);

    /// <summary>
    /// test model
    /// </summary>
    const TestModelPos* m_model;
...
#endif /* TEST_GRAPHICS_PIPELINE_POS_H */
