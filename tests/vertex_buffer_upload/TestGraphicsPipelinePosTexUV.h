#ifndef TEST_GRAPHICS_PIPELINE_POS_TEX_UV_H
#define TEST_GRAPHICS_PIPELINE_POS_TEX_UV_H
...
class TestGraphicsPipelinePosTexUV
{
  public:
    TestGraphicsPipelinePosTexUV(GraphicsCore& graphics);
    ~TestGraphicsPipelinePosTexUV();
    ...
    /// model to render
    /// </param>
    void SetModel(const TestModelPosTexUV* model);
  ...
  private:
    // disabled
    TestGraphicsPipelinePosTexUV();
    TestGraphicsPipelinePosTexUV(const TestGraphicsPipelinePosTexUV& cpy);
    TestGraphicsPipelinePosTexUV& operator=(const TestGraphicsPipelinePosTexUV& cpy);

    /// <summary>
    /// test model
    /// </summary>
    const TestModelPosTexUV* m_model;
...
#endif /* TEST_GRAPHICS_PIPELINE_POS_TEX_UV_H */
