#ifndef TEST_GRAPHICS_PIPELINE_POS_COLOR_H
#define TEST_GRAPHICS_PIPELINE_POS_COLOR_H
...
class TestGraphicsPipelinePosColor
{
  public:
    TestGraphicsPipelinePosColor(GraphicsCore& graphics);
    ~TestGraphicsPipelinePosColor();
    ...
    /// model to render
    /// </param>
    void SetModel(const TestModelPosColor* model);
  ...
  private:
    // disabled
    TestGraphicsPipelinePosColor();
    TestGraphicsPipelinePosColor(const TestGraphicsPipelinePosColor& cpy);
    TestGraphicsPipelinePosColor& operator=(const TestGraphicsPipelinePosColor& cpy);

    /// <summary>
    /// test model
    /// </summary>
    const TestModelPosColor* m_model;
...
#endif /* TEST_GRAPHICS_PIPELINE_POS_COLOR_H */
