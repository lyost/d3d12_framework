...
class TestGraphicsPipeline
{
  public:
    ...
    /// </summary>
    /// <param name="index">
    /// index of the viewport.  Must be in the range [0, NUM_VIEWPORTS)
    /// </param>
    /// <param name="cam">
    /// camera to use for the viewport
    /// </param>
    void SetCamera(UINT index, const Camera* cam);
  ...
  private:
    ...
    /// core graphics interface
    /// </param>
    void CreateDepthStencil(const GraphicsCore& graphics);
