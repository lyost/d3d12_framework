...
class TestGraphicsPipeline
{
  public:
    ...
    /// <summary>
    /// Retrieves the current texturing mode
    /// </summary>
    /// <returns>
    /// current texturing mode
    /// </returns>
    TextureModes GetMode() const;

    /// <summary>
    /// Sets the texture mode to test
    /// </summary>
    /// <param name="mode">
    /// texture mode to use
    /// </param>
    void SetMode(TextureModes mode);

    /// <summary>
    /// Retrieves the mipmap level
    /// </summary>
    /// <returns>
  ...
  private:
    ...
    /// <summary>
    /// current level of mipmapping to use
    /// </summary>
    UINT m_current_mipmap_level;
};
