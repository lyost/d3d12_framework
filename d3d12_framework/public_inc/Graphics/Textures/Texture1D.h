...
class Texture1D
{
  public:
    ...
    /// </exception>
    static Texture1D* CreateD3D12(const GraphicsCore& graphics, ShaderResourceDescHeap& shader_buffer_heap, UINT width, GraphicsDataFormat format, UINT16 mip_levels = 1);
